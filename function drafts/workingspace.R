...
UTRlist[[loci[1]]]<-featureselect(hlaAdf, 1,2, hlaAdf)
UTRlist[[loci[2]]]<-featureselect(hlaBdf, 2,2, hlaBdf)
UTRlist[[loci[3]]]<-featureselect(hlaCdf, 3,2, hlaCdf)
UTRlist[[loci[4]]]<-featureselect(hlaDPA1df, 4,2, hlaDPA1df)
UTRlist[[loci[5]]]<-featureselect(hlaDPB1df, 5,2, hlaDPB1df)
UTRlist[[loci[6]]]<-featureselect(hlaDQA1df, 6,2, hlaDQA1df)
UTRlist[[loci[7]]]<-featureselect(hlaDQB1df, 7,2, hlaDQB1df)
UTRlist[[loci[8]]]<-featureselect(hlaDRB1df, 8,2, hlaDRB1df)
UTRlist[[loci[9]]]<-featureselect(hlaDRB3df, 9,2, hlaDRB3df)
UTRlist[[loci[10]]]<-featureselect(hlaDRB4df, 10, 2, hlaDRB4df)
UTRlist[[loci[11]]]<-featureselect(hlaDRB5df, 11,2, hlaDRB5df)
...
UTRisolated<-list()
UTRisolated[[loci[1]]]<-GFEpaster(UTRlist, 1, hlaAdf, hladf, 1, "HLA-A*00:00")
UTRisolated[[loci[2]]]<-GFEpaster(UTRlist, 2, hlaBdf, hladf, 2, "HLA-B*00:00")
UTRisolated[[loci[3]]]<-GFEpaster(UTRlist, 3, hlaCdf, hladf, 3, "HLA-C*00:00")
UTRisolated[[loci[4]]]<-GFEpaster(UTRlist, 4, hlaDPA1df, hladf, 4, "HLA-DPA1*00:00")
UTRisolated[[loci[5]]]<-GFEpaster(UTRlist, 5, hlaDPB1df, hladf, 5, "HLA-DPB1*00:00")
UTRisolated[[loci[6]]]<-GFEpaster(UTRlist, 6, hlaDQA1df, hladf, 6, "HLA-DQA1*00:00")
UTRisolated[[loci[7]]]<-GFEpaster(UTRlist, 7, hlaDQB1df, hladf, 7, "HLA-DQB1*00:00")
UTRisolated[[loci[8]]]<-GFEpaster(UTRlist, 8, hlaDRB1df, hladf, 8, "HLA-DRB1*00:00")
UTRisolated[[loci[9]]]<-GFEpaster(UTRlist, 9, hlaDRB3df, hladf, 9, "HLA-DRB3*00:00")
UTRisolated[[loci[10]]]<-GFEpaster(UTRlist, 10, hlaDRB4df, hladf, 10, "HLA-DRB4*00:00")
