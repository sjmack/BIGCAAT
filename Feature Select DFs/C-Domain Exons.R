####Feature Sequence Isolation for C-Domain Exon GFEs
...
featureselect<-function(dataframe, x, y, GFEsplitDF){
  ...
  Cdomlist[[loci[1]]]<-featureselect(hlaAdf, 1,6, hlaAdf)
  Cdomlist[[loci[2]]]<-featureselect(hlaBdf, 2,6, hlaBdf)
  Cdomlist[[loci[3]]]<-featureselect(hlaCdf, 3,6, hlaCdf)
  Cdomlist[[loci[4]]]<-featureselect(hlaDPA1df, 4,6, hlaDPA1df)
  Cdomlist[[loci[5]]]<-featureselect(hlaDPB1df, 5,6, hlaDPB1df)
  Cdomlist[[loci[6]]]<-featureselect(hlaDQA1df, 6,6, hlaDQA1df)
  Cdomlist[[loci[7]]]<-featureselect(hlaDQB1df, 7,6, hlaDQB1df)
  Cdomlist[[loci[8]]]<-featureselect(hlaDRB1df, 8,6, hlaDRB1df)
  Cdomlist[[loci[9]]]<-featureselect(hlaDRB3df, 9,6, hlaDRB3df)
  Cdomlist[[loci[10]]]<-featureselect(hlaDRB4df, 10, 6, hlaDRB4df)
  Cdomlist[[loci[11]]]<-featureselect(hlaDRB5df, 11,6, hlaDRB5df)
  ...
  CDomIsolatedated<-list()
  CDomIsolatedated[[loci[1]]]<-GFEpaster(Cdomlist, 1, hlaAdf, hladf, 1, "HLA-A*00:00")
  CDomIsolatedated[[loci[2]]]<-GFEpaster(Cdomlist, 2, hlaBdf, hladf, 2, "HLA-B*00:00")
  CDomIsolatedated[[loci[3]]]<-GFEpaster(Cdomlist, 3, hlaCdf, hladf, 3, "HLA-C*00:00")
  CDomIsolatedated[[loci[4]]]<-GFEpaster(Cdomlist, 4, hlaDPA1df, hladf, 4, "HLA-DPA1*00:00")
  CDomIsolatedated[[loci[5]]]<-GFEpaster(Cdomlist, 5, hlaDPB1df, hladf, 5, "HLA-DPB1*00:00")
  CDomIsolatedated[[loci[6]]]<-GFEpaster(Cdomlist, 6, hlaDQA1df, hladf, 6, "HLA-DQA1*00:00")
  CDomIsolatedated[[loci[7]]]<-GFEpaster(Cdomlist, 7, hlaDQB1df, hladf, 7, "HLA-DQB1*00:00")
  CDomIsolatedated[[loci[8]]]<-GFEpaster(Cdomlist, 8, hlaDRB1df, hladf, 8, "HLA-DRB1*00:00")
  CDomIsolatedated[[loci[9]]]<-GFEpaster(Cdomlist, 9, hlaDRB3df, hladf, 9, "HLA-DRB3*00:00")
  CDomIsolatedated[[loci[10]]]<-GFEpaster(Cdomlist, 10, hlaDRB4df, hladf, 10, "HLA-DRB4*00:00")
  CDomIsolatedated[[loci[11]]]<-GFEpaster(Cdomlist, 11, hlaDRB5df, hladf, 11, "HLA-DRB5*00:00")  
