####Feature Sequence Isolation for Non-Core Exons GFEs
...
NoncoreExons[[loci[1]]]<-featureselect(hlaAdf, 1,9, hlaAdf)
NoncoreExons[[loci[2]]]<-featureselect(hlaBdf, 2,9, hlaBdf)
NoncoreExons[[loci[3]]]<-featureselect(hlaCdf, 3,9, hlaCdf)
NoncoreExons[[loci[4]]]<-featureselect(hlaDPA1df, 4,9, hlaDPA1df)
NoncoreExons[[loci[5]]]<-featureselect(hlaDPB1df, 5,9, hlaDPB1df)
NoncoreExons[[loci[6]]]<-featureselect(hlaDQA1df, 6,9, hlaDQA1df)
NoncoreExons[[loci[7]]]<-featureselect(hlaDQB1df, 7,9, hlaDQB1df)
NoncoreExons[[loci[8]]]<-featureselect(hlaDRB1df, 8,9, hlaDRB1df)
NoncoreExons[[loci[9]]]<-featureselect(hlaDRB3df, 9,9, hlaDRB3df)
NoncoreExons[[loci[10]]]<-featureselect(hlaDRB4df, 10, 9, hlaDRB4df)
NoncoreExons[[loci[11]]]<-featureselect(hlaDRB5df, 11,9, hlaDRB5df)
...
NoncoreExonsIsolated<-list()
NoncoreExonsIsolated[[loci[1]]]<-GFEpaster(NoncoreExons, 1, hlaAdf, hladf, 1, "HLA-A*00:00")
NoncoreExonsIsolated[[loci[2]]]<-GFEpaster(NoncoreExons, 2, hlaBdf, hladf, 2, "HLA-B*00:00")
NoncoreExonsIsolated[[loci[3]]]<-GFEpaster(NoncoreExons, 3, hlaCdf, hladf, 3, "HLA-C*00:00")
NoncoreExonsIsolated[[loci[4]]]<-GFEpaster(NoncoreExons, 4, hlaDPA1df, hladf, 4, "HLA-DPA1*00:00")
NoncoreExonsIsolated[[loci[5]]]<-GFEpaster(NoncoreExons, 5, hlaDPB1df, hladf, 5, "HLA-DPB1*00:00")
NoncoreExonsIsolated[[loci[6]]]<-GFEpaster(NoncoreExons, 6, hlaDQA1df, hladf, 6, "HLA-DQA1*00:00")
NoncoreExonsIsolated[[loci[7]]]<-GFEpaster(NoncoreExons, 7, hlaDQB1df, hladf, 7, "HLA-DQB1*00:00")
NoncoreExonsIsolated[[loci[8]]]<-GFEpaster(NoncoreExons, 8, hlaDRB1df, hladf, 8, "HLA-DRB1*00:00")
NoncoreExonsIsolated[[loci[9]]]<-GFEpaster(NoncoreExons, 9, hlaDRB3df, hladf, 9, "HLA-DRB3*00:00")
NoncoreExonsIsolated[[loci[10]]]<-GFEpaster(NoncoreExons, 10, hlaDRB4df, hladf, 10, "HLA-DRB4*00:00")
NoncoreExonsIsolated[[loci[11]]]<-GFEpaster(NoncoreExons, 11, hlaDRB5df, hladf, 11, "HLA-DRB5*00:00")  
